...
icon: "lock"
description: "How to authenticate with Ringg AI's API using API keys"
...
1. Log in to your [Ringg AI dashboard](https://www.ringg.ai/dashboard/api)
2. Select **API** from the sidebar navigation
3. Click the **Regenerate** button to create a new API key

<Frame caption="X-API-KEY">
    <img src="/images/api_key.png" alt="Obtaining Your Ringg API Key" />
</Frame>
...
To ensure fair usage and system stability, Ringg AI implements rate limiting on API requests.
