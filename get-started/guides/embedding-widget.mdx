...
<Note>
Building a mobile app instead? The same widget ships natively for [React Native](/get-started/guides/widget-react-native) and [Flutter](/get-started/guides/widget-flutter) — same conversation behavior, native views.
</Note>
