...
<Note>
Building a mobile app instead? The same widget ships natively for [React Native](/get-started/guides/widget-react-native) and [Flutter](/get-started/guides/widget-flutter), with the same conversation behavior and native views.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="React Native" icon="smartphone" href="/get-started/guides/widget-react-native">
    The same widget in a React Native or Expo app, with `@ringg/react-native`.
  </Card>
  <Card title="Flutter" icon="smartphone-charging" href="/get-started/guides/widget-flutter">
    The same widget in a Flutter app, with the `ringg_flutter` package.
  </Card>
</CardGroup>
