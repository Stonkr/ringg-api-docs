...
<Note>
**Looking for events your agent triggers during a call** (focus an input, open a modal, scroll somewhere)? See [Agent actions](/get-started/guides/embedding-widget-components-data#agent-actions). This page covers events the widget itself emits about its own state.
</Note>
