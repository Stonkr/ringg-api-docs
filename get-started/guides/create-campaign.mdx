...
Review your settings and click **Create Campaign** (or **Launch**) to activate it.

- If the start time is in the future, the campaign will be in **Scheduled** state.
- If the start time is now or in the past, it will immediately begin dialling in **Running** state.
...
- **Clone** a campaign to reuse its settings
