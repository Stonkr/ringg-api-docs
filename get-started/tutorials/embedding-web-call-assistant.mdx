...
loadAgent({
  ...
  innerWindowProps?: {
     ...
     * All values accept a number (px) or any valid CSS size string.
     * Supported from v1.0.8+
     */
    width?: number | string,
  ...
  title?: string,
     ...
     * Example: { backgroundColor: "#4CAF50", padding: "8px", border: "2px solid #333" }
     * Supported from v1.0.10+
     */
     ...
     * Supported from v1.0.10+
     * Words in 'text' that match keys in 'links' become clickable (case-sensitive).
     * Example:
     * {
