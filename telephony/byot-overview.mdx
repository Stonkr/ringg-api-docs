...
<CardGroup cols={3}>
  <Card title="Plivo" icon="phone" href="/telephony/plivo-integration">
    Global cloud communications platform with competitive pricing
  </Card>
  <Card title="Exotel" icon="phone" href="/telephony/exotel-integration">
    India-focused cloud telephony platform with robust regional support
  </Card>
  <Card title="Twilio" icon="phone" href="/telephony/twilio-integration">
