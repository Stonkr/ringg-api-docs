...
Our webhook system supports five event types. You can subscribe to **any or all** of these events based on your needs:
...
--data '{
    ...
    "event_subscriptions": [
        {
            "event_type": ["call_started", "call_completed", "recording_completed", "platform_analysis_completed", "client_analysis_completed"],
