...
Our webhook system supports six event types. You can subscribe to **any or all** of these events based on your needs:

| Event Type | Trigger | Data Included |
|------------|---------|---------------|
| `call_started` | A call is initiated | Agent name, version info, custom args |
...
| `all_processing_completed` | All post-call processing is done | Full call data: transcript, recording, both analyses |
...
--data '{
    ...
    "event_subscriptions": [
        {
            "event_type": ["call_started", "call_completed", "recording_completed", "platform_analysis_completed", "client_analysis_completed", "all_processing_completed"],
        ...
        {
            "event_type": ["call_completed", "recording_completed"],
            "callback_url": "https://your-another-domain.com/webhooks",
            "headers": {
                "Authorization": "Bearer your-webhook-token",
                "Content-Type": "application/json"
            },
...
```json
{
    ...
    "event_subscriptions": [
        {
            "event_type": ["platform_analysis_completed", "client_analysis_completed"],
